...
import 'package:delight/core/providers/storage_repository_provider.dart';
import 'package:delight/core/utils.dart';
import 'package:delight/features/auth/controllers/auth_controller.dart';
import 'package:delight/features/community/repository/community_repository.dart';
...
// Provider for fetching the community data of the current USER
...
final communityControllerProvider =
  ...
  final communiyRepository = ref.watch(
    communityRepositoryProvider,
  );
  return CommunityController(
    communityRepository: communiyRepository,
    ref: ref,
    storageRepository: ref.watch(storageRepositoryProvider),
  );
});

// Provider for get community by name
...
// Sream Provider for search community function
final searchCommunityProvider = StreamProvider.family((ref, String query) {
  return ref.watch(communityControllerProvider.notifier).searchCommunity(query);
});

// Provider to show all posts of a community
...
class CommunityController extends StateNotifier<bool> {
  ...
  void joinCommunity(Community community, BuildContext context) async {
    ...
    if (community.members.contains(user.uid)) {
      // user needs to leave the community
